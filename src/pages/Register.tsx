...
import { Wind, User, Mail, Lock, ShieldCheck, ArrowRight } from 'lucide-react'
  ...
  <div className="auth-page">
    <div className="auth-page__visual">
      ...
      <div className="auth-page__visual-quote">
        <p className="auth-page__visual-quote-text">
          "We onboarded in under 48 hours. The digital twin changed everything for our operations team."
        </p>
        <span className="auth-page__visual-quote-author">
          — Anna Lindström, Head of Operations at Nordic Wind AB
        </span>
      </div>
    </div>
    ...
    <div className="auth-page__form">
      <div className="auth-page__header">
        ...
        <p className="auth-page__subtitle">Start managing your wind farm today</p>
      </div>
      ...
      <div className="auth-page__fields">
        <div className="form-field">
          ...
          <div className="form-field__input-wrap">
            <User size={18} />
            <input type="text" className="form-field__input" placeholder="Enter your full name" />
          </div>
        </div>

        <div className="form-field">
          <label className="form-field__label">WORK EMAIL</label>
          <div className="form-field__input-wrap">
            <Mail size={18} />
            <input type="email" className="form-field__input" placeholder="Enter your work email" />
          </div>
        </div>
        ...
        <div className="form-field">
          ...
          <div className="form-field__input-wrap">
            <ShieldCheck size={18} />
            <input type="password" className="form-field__input" placeholder="Confirm your password" />
          </div>
        </div>
      </div>
      ...
      <div className="auth-page__actions">
        ...
        <div className="auth-page__switch">
          <span className="auth-page__switch-text">Already have an account?</span>
